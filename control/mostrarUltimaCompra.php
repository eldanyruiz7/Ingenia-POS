...
else
{
    ...
    {
        $sql = "SELECT
                    compras.id                  AS idVenta,
                    compras.timestamp           AS fechaHora,
                    compras.proveedor           AS idProveedor,
                    compras.usuario             AS idUsuario,
                    compras.monto               AS totalVenta,
                    compras.corte               AS corteCaja,
                    compras.pagado              AS pagado,
                    compras.esfactura           AS remision,
                    proveedores.nombres         AS nombreProveedor,
                ...
                ORDER BY compras.id DESC LIMIT 1";
    }
    else
    {
        if ($orden == 1)
        ...
        $sql = "SELECT
                ...
                INNER JOIN metodosdepago
                ON compras.metododepago = metodosdepago.id
                WHERE compras.id = $idVentaActual LIMIT 1";
    }
    ...
    $iconoVenta     = ($row['remision'] == 0) ? '<i class="fa fa-print" aria-hidden="true"></i> Remisi&oacute;n' : '<i class="fa fa-rocket" aria-hidden="true"></i> Factura';
    ...
    <div class="col-lg-12 col-md-12">
       <div class="panel panel-success">
           <div class="panel-heading">
               <label>INFORMACI&Oacute;N DE LA COMPRA </label>
           </div>
           <!-- /.panel-heading -->
      ...
      <div class="panel-body">
       ...
       <?php
           ...
           $sql = "SELECT
            ...
            WHERE detallecompra.compra = $idVenta";
            $cont = 1;
