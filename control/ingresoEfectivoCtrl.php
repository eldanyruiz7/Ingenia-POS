...
?>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <form id="formRetiro" role="form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                        ...
                        <input type="button" name="btnRetirar" value="Ingresar" id="btnRetirar" class="btn btn-lg btn-info btn-block">
    ...
    $("#formRetiro").submit(function(e){
            ...
            [
                {
                    ...
                    click: function()
                    {
                        ...
                        {
                           type: "POST",
                           url: "../control/ingresoEfectivoBd.php",
        ...
        <div id="dialog-confirm-retirar" title="Ingresar efectivo">
            <p>
