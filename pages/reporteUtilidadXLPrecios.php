...
<head>
    ...
    <title>Reporte utilidades por lista de precios</title>
    <!-- Bootstrap Core CSS -->
...
<?php include "nav.php" ?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="page-header"> <i class="fa fa-file-text-o" aria-hidden="true"></i> Reporte de utilidades por lista de precios</h1>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-success">
                        ...
                        <form role="form" method="POST" action="../control/reporteUtilidadXLPrecios.php" target="_blank">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select multiple="multiple" id="selectDepartamentos" name="selectDepartamentos[]" size="9" class="form-control">
                            <?php
                            ...
                            ?>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Mostrar Art&iacute;culos</label>
                                            <div class="radio">
                                                <label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select class="form-control" name="selectOrden">
                                                ...
                                                <option value="2">Existencias</option>
                                    ...
                                    <div class="col-lg-4 col-lg-offset-4">
                                        <button type="submit" class="btn btn-success btn-lg btn-block"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Generar reporte</button>
                                    </div>
                                </div>
                                <!-- /.row (nested) -->
                            </div>
