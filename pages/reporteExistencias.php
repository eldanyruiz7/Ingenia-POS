...
<?php include "nav.php" ?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="page-header"> <i class="fa fa-file-text-o" aria-hidden="true"></i> Reporte de existencias</h1>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-success">
                        ...
                        <form role="form" method="POST" action="../control/reporteExistencias.php" target="_blank">
