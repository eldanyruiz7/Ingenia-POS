...
<head>
    ...
    <title>Reporte de complementos de pago</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-8 col-md-9 col-sm-12 col-xs-12">
                    <h1 class="page-header"> <i class="fa fa-rocket" aria-hidden="true"></i> Reporte de complementos de pago</h1>
                </div>
            </div>
            <!-- /.row -->
            <div class="row">
    ...
    <?php
     ...
     ?>
            ...
            <?php
                ...
                if ($consultar == 1)
                {
                    ...
                    $sql = "SELECT
                                ...
                                facturas.montoPago          AS montoPago,
                                facturas.pagado             AS pagado,
                                facturas.idRelacion         AS idRelacion,
            ...
            ?>
                                ...
                                <tr class="rowReporte" name="<?php echo $rowVenta['id'];?>" email-receptor="<?php echo $rowVenta['emailReceptor'];?>" razon-receptor="<?php echo $rowVenta['razonReceptor'];?>">
                                    <td>
                                        <div class="btn-group pull-left">
                                            ...
                                            <ul class="dropdown-menu slidedown">
                                            <li>
                                                <a class="aReimprimirTkt" name="<?php echo $rowVenta['idVenta_'];?>">
                                ...
                                <td class="text-right">
                                    <?php echo "$".number_format($rowVenta['montoPago'],2,".",","); ?>
                                </td>
                            </tr>
                <?php
                        $total_total    += $rowVenta['montoPago'];
                        }
                    }
                }
                ?>
